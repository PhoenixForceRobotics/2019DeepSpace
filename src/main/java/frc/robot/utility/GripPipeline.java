...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hslThresholdHue = {25.899273821775857, 101.16041736798074};
		double[] hslThresholdSaturation = {0.0, 255.0};
		double[] hslThresholdLuminance = {48.920864767307854, 255.0};
		...
		double[] filterLinesAngle = {192.0863391684114, 302.6621472876226};
